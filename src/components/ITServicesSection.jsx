...
import { Lightbulb, Wrench, FileCheck, Settings, Headphones, Monitor, Wifi } from "lucide-react";
import "./ITServicesSection.css";
import "./FlipCard.css";

const IT_SERVICES = [
    { id: "it-consulting", icon: Lightbulb, title: "IT Consulting", desc: "Strategic technology guidance to align your IT infrastructure with business goals and drive digital transformation.", color: "#2563eb", rgb: "37,99,235" },
    { id: "installation-services", icon: Wrench, title: "One Time Installation Services", desc: "Professional setup and configuration of hardware, software, and network systems — done right the first time.", color: "#7c3aed", rgb: "124,58,237" },
    { id: "amc", icon: FileCheck, title: "Annual Maintenance Contract", desc: "Comprehensive AMC plans that keep your IT systems running at peak performance with scheduled maintenance.", color: "#059669", rgb: "5,150,105" },
    { id: "regular-maintenance", icon: Settings, title: "Regular Maintenance Services", desc: "Proactive, routine maintenance to prevent downtime, extend hardware life, and ensure system reliability.", color: "#d97706", rgb: "217,119,6" },
    { id: "oncall-support", icon: Headphones, title: "Oncall Support", desc: "Rapid on-demand technical support whenever you need it — minimizing disruption and maximizing uptime.", color: "#e11d48", rgb: "225,29,72" },
    { id: "remote-management", icon: Monitor, title: "Remote Management IT Services", desc: "24/7 remote monitoring and management of your IT environment, resolving issues before they impact operations.", color: "#0891b2", rgb: "8,145,178" },
    { id: "internet-intranet", icon: Wifi, title: "Internet & Intranet", desc: "End-to-end network design, deployment, and management for reliable internet and secure intranet connectivity.", color: "#6d28d9", rgb: "109,40,217" },
];
            ...
            <div className="it-services__container">
                <div className="it-services__header" ref={headerRef}>
                    ...
                    <motion.p className="it-services__subheading" variants={headingVariants} custom={2} initial="hidden" animate={headerView ? "visible" : "hidden"}>
                        End-to-end IT solutions designed to keep your business running smoothly, securely, and efficiently — from consulting to 24/7 support.
                    </motion.p>
