...
const cardVariants = { hidden: { opacity: 0, scale: 0.92, y: 30 }, visible: { opacity: 1, scale: 1, y: 0, transition: { duration: 0.55, ease: [0.22, 1, 0.36, 1] } } };

function ProductCard({ id, icon: Icon, title, desc, color, rgb }) {
        ...
        <section className="products" id="products">
            ...
            <div className="products__container">
                <div className="products__top" ref={headerRef}>
                    <motion.div className="products__top-left" initial={{ opacity: 0, x: -40 }} animate={headerView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] }}>
                        <div className="products__tag"><span className="products__tag-dot" />HARDWARE &amp; SALES</div>
                        <h2 className="products__heading">Our <span className="products__heading-accent">Products</span></h2>
